	...
	<div class="row col 12">
		...
		<div class="col s9 green">
			<div class="row">
				<nav>
					<div class="nav-wrapper green">
						<a href="#" class="brand-logo center">Últimas doações de
							empresas</a>
					</div>
				</nav>
			</div>
			...
			<div class="container">
				<c:forEach items="${listaDoacoesEmpresas}" var="item"
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<h6 class="center center-align">
									<h6>
										<b>${item.get(0) }</b> doou para <b>${item.get(3) }</b>
									</h6>
								</h6>
								</p>
								...
								<span><h6>
										...
										<b>Doação:</b> ${item.get(6)}x ${item.get(5)}
									</h6></span> <span><h6>
										<b>Mensagem: </b>
									</h6>${item.get(7)}</span>
							</div>
